const games = [
  {
    ...
    "descriptions": [
      ...
      },
      {
        ...
        "content": "Frostpunk allows players to shape their society through the introduction of laws that regulate daily life. Players must decide how to handle healthcare, food distribution, and labor practices, often balancing the harsh needs of survival with the moral consequences of their decisions."
      },
      {
        "title": "Technological Progress",
        "content": "Survival in Frostpunk hinges on technological innovation. Players must research and develop advanced infrastructure like automatons and steam-powered devices to ensure the survival of their city. Balancing short-term needs with long-term technological progress is key to success."
      },
      {
        "title": "Moral Choices",
      ...
      },
      {
        ...
        "content": "For players seeking a less structured experience, Frostpunk offers an Endless Mode that allows you to build and manage your city without the constraints of the main story. Multiple maps and challenges provide varying levels of difficulty, offering long-term replayability."
      }
    ],
    "price": 29.99,
    "discount": 20,
  ...
  },
  {
    ...
    "descriptions": [
      ...
      {
        "title": "Gameplay",
        "content": "In this 2D Metroidvania-style game, players navigate expansive non-linear environments while battling enemies and uncovering hidden lore. The game emphasizes exploration, tight combat, and the acquisition of new abilities to unlock further areas."
      },
      {
        "title": "Atmosphere",
        "content": "Hollow Knight's atmospheric world is eerie yet mesmerizing, characterized by dark caverns, fungal forests, and forgotten ruins. Each zone is distinct in its visuals and gameplay design, contributing to the game's immersive storytelling."
      },
      {
        "title": "Combat and Abilities",
        "content": "The knight wields a sword-like weapon called a nail. Players must master a variety of attacks, dodging, and platforming mechanics. Throughout the game, players unlock abilities like double-jumping and dashing to progress deeper into Hallownest."
      },
      {
        "title": "Challenges and Bosses",
        "content": "Hollow Knight is known for its challenging boss battles, each requiring quick reflexes and precise timing. Boss fights are a highlight, offering a mix of puzzle-solving and combat, testing the player's mastery of the knight's abilities."
      },
      {
        "title": "Exploration",
        "content": "The map of Hallownest is vast, filled with hidden passages, secret areas, and cryptic messages. The game encourages players to explore every corner, with plenty of rewards for the curious, including new weapons, charms, and lore."
      },
      {
  ...
  },
  {
    ...
    "descriptions": [
      ...
      {
        "title": "Gameplay",
        "content": "Hades combines hack-and-slash combat with strategic decision-making. Players fight their way through procedurally generated rooms filled with enemies and bosses. The game's combat system emphasizes fluidity, as players string together attacks, dodges, and special abilities."
      },
      {
        "title": "Boon System",
        "content": "One of the core gameplay mechanics involves the Boon system, where various gods of Olympus offer their assistance in the form of upgrades to Zagreus's abilities. These Boons allow for customization of playstyle, enhancing weapons and special attacks."
      },
      {
        "title": "Narrative Depth",
        "content": "Hades boasts a rich narrative, woven seamlessly into the game's rogue-like structure. Players build relationships with various gods, heroes, and figures from Greek mythology, each encounter deepening the lore and providing character development."
      },
      {
        "title": "Art and Music",
        "content": "Supergiant Games is known for its stunning art direction, and Hades is no exception. The vibrant, hand-drawn environments, characters, and animations bring the underworld to life, while the soundtrack, composed by Darren Korb, enhances the atmosphere with a mix of epic and eerie melodies."
      },
      {
        "title": "Replayability",
        "content": "Hades is designed for replayability, with each escape attempt offering new challenges, dialogue, and story developments. The rogue-like structure keeps the game fresh, rewarding players for skillful play and experimentation with different builds."
      },
      {
        "title": "Character Interactions",
        "content": "As Zagreus interacts with different characters, players unlock unique storylines and abilities. Gifts, quests, and dialogues contribute to the evolving relationships between the protagonist and the denizens of the underworld."
      }
    ],
    "price": 24.99,
    "discount": 0,
  ...
  },
  {
    ...
    "descriptions": [
      ...
      {
        "title": "Gameplay",
        "content": "Players take control of a failed alchemic experiment trying to escape from a mysterious island. Dead Cells features fast-paced, responsive combat where players must dodge, parry, and strike enemies while combining various weapons and abilities. Death is frequent but rewarding as players retain certain upgrades between runs."
      },
      {
        "title": "Weapons and Abilities",
        "content": "Players have access to a wide variety of weapons, ranging from swords and bows to powerful spells and gadgets. The game allows for deep customization of combat builds, with players able to mix and match different weapons, mutations, and skills."
      },
      {
        "title": "Exploration",
        "content": "Dead Cells features procedurally generated levels that offer new challenges and secrets with every run. Players can unlock shortcuts and secret areas by finding permanent upgrades, such as the ability to grow vines or break floors, allowing access to previously inaccessible zones."
      },
      {
        "title": "Progression",
        "content": "While Dead Cells is a rogue-lite, meaning death resets your progress, permanent unlocks such as new weapons, blueprints, and upgrades help ease future runs. Players earn cells from defeating enemies, which can be invested in upgrading equipment or unlocking new abilities."
      },
      {
        "title": "Art and Music",
        "content": "The game's pixel art style is both vibrant and detailed, with beautifully animated characters and environments. The soundtrack, composed by Yoann Laulan, complements the action with energetic, atmospheric tracks that heighten the tension of each run."
      },
      {
        "title": "Replayability",
        "content": "Dead Cells is designed with replayability in mind. Its randomized levels, varied enemies, and weapon combinations ensure that each run feels unique. The game also offers different difficulty modes and additional content through updates and DLC."
      }
    ],
    "price": 24.99,
    "discount": 20,
  ...
  },
  {
    ...
    "descriptions": [
      ...
      {
        "title": "Gameplay",
        "content": "The game features challenging combat, punishing difficulty, and intricate platforming. Players must traverse a non-linear world filled with dangerous enemies and traps, using a variety of melee attacks, dodges, and spells to survive. Combat is methodical, requiring precise timing and strategic use of abilities."
      },
      {
        "title": "Guilt and Penitence",
        "content": "A unique mechanic in Blasphemous is the Guilt system. Each time the player dies, a portion of their fervor (used for casting spells) is locked away, and a 'Guilt Fragment' is left where they died. Players must retrieve these fragments to regain their full strength, adding a layer of tension to every death."
      },
      {
        "title": "Religious Symbolism",
        "content": "The world of Cvstodia is steeped in dark religious themes, with imagery and characters that evoke penitence, martyrdom, and atonement. The story unfolds through cryptic dialogues, item descriptions, and environmental storytelling, adding to the atmosphere of despair and suffering."
      },
      {
        "title": "Boss Fights",
        "content": "Blasphemous features numerous large-scale, visually striking boss battles that test the player's skill and reflexes. Each boss is a twisted reflection of the world's themes, presenting unique challenges and requiring careful observation to defeat."
      },
      {
        "title": "Visuals and Art Direction",
        "content": "The pixel art in Blasphemous is highly detailed, capturing both the beauty and horror of the world. The game's environments range from ruined cathedrals to desolate wastelands, all rendered with painstaking attention to detail. The grotesque, religious-inspired art direction creates a hauntingly oppressive atmosphere."
      },
      {
        "title": "Music and Sound Design",
        "content": "The game's soundtrack, composed by Carlos Viola, combines somber orchestral pieces with eerie, haunting melodies that perfectly match the game's tone. The sound design heightens the experience, from the clanging of swords to the unsettling background noises."
      },
      {
        "title": "Replayability",
        "content": "Blasphemous offers replayability through its intricate world design, multiple endings, and hidden secrets. Players can explore different paths and uncover lore by completing side quests and finding hidden items. The game's punishing difficulty ensures that mastery is hard-earned, offering a rewarding experience for those willing to persevere."
      }
    ],
    "price": 24.99,
    "discount": 25,
  ...
  },
  {
    ...
    "descriptions": [
      ...
      {
        "title": "World of the Lands Between",
        "content": "The Lands Between is a fantastical realm divided into multiple regions, each with its own unique landscapes, enemies, and dungeons. Players can explore dense forests, towering castles, swamps, and ancient ruins, discovering hidden secrets along the way."
      },
      {
        "title": "Combat and Strategy",
        "content": "Elden Ring's combat is similar to FromSoftware's other games, such as Dark Souls and Bloodborne. Players engage in challenging, skill-based battles against enemies of varying strength, using a combination of melee attacks, magic, and ranged combat. The game rewards tactical thinking and precise timing."
      },
      {
        "title": "Lore and Storytelling",
        "content": "The narrative of Elden Ring is woven into its world. Lore is discovered through cryptic NPC dialogue, item descriptions, and environmental cues, adding depth to the player's journey. The story revolves around the shattered Elden Ring and the quest to become the Elden Lord."
      },
      {
        "title": "Character Customization",
        "content": "Players can fully customize their characters, choosing between various classes and skill paths. This includes melee-focused builds, magic-wielding sorcerers, or a hybrid approach, offering a flexible system that lets players tailor their playstyle."
      },
      {
        "title": "Multiplayer Experience",
        "content": "Elden Ring also features a multiplayer mode, where players can summon allies to help with challenging bosses or invade other players' worlds for PvP combat. The online aspect adds another layer of depth, allowing for unique encounters and cooperative play."
      }
    ],
    "price": 59.99,
    "discount": 0,
  ...
  },
  {
    ...
    "descriptions": [
      ...
      {
        "title": "Story and Setting",
        "content": "Hornet finds herself in a new, unfamiliar kingdom ruled by silk and song. Her journey leads her through a diverse world of forests, caverns, and cities, with a fresh set of challenges and mysteries. Players will unravel the fate of the kingdom's inhabitants and the ancient evils lurking within."
      },
      {
        "title": "Gameplay Mechanics",
        "content": "Silksong builds upon the tight, responsive combat of its predecessor, with Hornet's acrobatic movements and silk-based abilities adding new dimensions to platforming and combat. Hornet's nimble movement allows for faster, more dynamic combat encounters, as well as new ways to navigate through the world."
      },
      {
        "title": "Exploration",
        "content": "The kingdom of Silksong is teeming with secrets, hidden paths, and lore for players to uncover. Exploration is a key aspect, with new abilities unlocking access to previously unreachable areas, creating a rewarding sense of discovery."
      },
      {
        "title": "Crafting and Quests",
        "content": "Players can craft tools and traps using materials found throughout the world. In addition, Silksong introduces a quest system, with numerous NPCs offering challenges and rewards, enhancing the depth and engagement of the game's world."
      },
      {
        "title": "Boss Fights",
        "content": "As in Hollow Knight, Silksong's boss fights are a major highlight. Each boss presents a unique challenge, requiring players to learn their attack patterns and adjust their strategy accordingly. The bosses are beautifully designed and integral to the game's narrative."
      }
    ],
    "price": null,
    "discount": null,
  ...
  },
  {
    ...
    "descriptions": [
      ...
      {
        "title": "Atmosphere and Art Direction",
        "content": "Inside's art style is minimalist yet powerful, using stark lighting and muted colors to create a sense of dread and isolation. The sound design is equally minimalist, enhancing the eerie, foreboding mood as players progress through the game's environments."
      },
      {
        "title": "Puzzles and Gameplay",
        "content": "The game's puzzles are seamlessly integrated into its environments, requiring players to think creatively to progress. These puzzles grow more complex and involve manipulating the world in unique ways, such as controlling other characters or altering the environment."
      },
      {
        "title": "Narrative and Interpretation",
        "content": "Inside tells its story without dialogue, leaving much of the narrative open to interpretation. The game explores themes of control, oppression, and free will, with its ambiguous ending sparking much discussion among players and critics alike."
      },
      {
        "title": "Emotional Impact",
        "content": "Despite its simplicity, Inside delivers a powerful emotional experience. Its oppressive atmosphere and mysterious narrative keep players engaged, while the dark tone and disturbing imagery leave a lasting impression."
      }
    ],
    "price": 19.99,
    "discount": 0,
  ...
  },
  {
    ...
    "descriptions": [
      ...
      },
      {
        ...
        "content": "Combat in Wizard of Legend is fluid and combo-driven, with an emphasis on skillful chaining of spells. The player can combine elemental attacks like fire, water, and earth to create devastating spell combos. Fast movement and dodging are crucial to surviving challenging enemy encounters."
      },
      {
        "title": "Spell and Relic Customization",
        "content": "The game features over 100 spells, ranging from elemental blasts to teleportation abilities. Players also collect relics that enhance their spells or offer passive bonuses. The customization of a wizard's loadout is key to developing unique strategies, allowing for endless replayability."
      },
      {
        "title": "Dungeons and Procedural Generation",
        "content": "Each dungeon run in Wizard of Legend is procedurally generated, ensuring that no two playthroughs are the same. Players must face three elemental-themed dungeon bosses before unlocking the final challenge. With every defeat, players are given the opportunity to refine their spell set and improve their chances of success."
      },
      {
        "title": "Multiplayer and Co-op",
        "content": "Wizard of Legend also supports local co-op multiplayer, allowing two players to team up and fight through dungeons together. This feature adds a new dynamic to the combat, as players can synergize their spells and develop joint strategies for taking down enemies and bosses."
      }
    ],
    "price": 15.99,
    "discount": 30,
  ...
  },
  {
    ...
    "descriptions": [
      ...
      {
        "title": "Gameplay Mechanics",
        "content": "Brawlhalla is a fast-paced fighting game where players try to knock their opponents off the stage. Players can perform a variety of attacks, including light combos and powerful signature moves tied to specific weapons. Weapons spawn randomly on the battlefield, adding an element of unpredictability to the fights."
      },
      {
        "title": "Character Variety",
        "content": "The game features over 50 unique Legends, each with their own special abilities and weapon combinations. Players can choose Legends that fit their preferred playstyle, from sword-wielding knights to blaster-equipped space heroes. Each Legend's moveset offers distinct gameplay opportunities."
      },
      {
        "title": "Competitive Scene",
        "content": "Brawlhalla has a thriving competitive community, with ranked ladders and seasonal tournaments. The game also features a variety of modes, including 1v1 duels, 2v2 team battles, and free-for-all brawls. With cross-play functionality, players from different platforms can compete against each other in real-time."
      },
      {
        "title": "Game Modes and Customization",
        "content": "Beyond its ranked matches, Brawlhalla offers casual modes and custom lobbies for more relaxed gameplay. Players can also collect skins, taunts, and other cosmetics to customize their Legends. With frequent updates and new content drops, the game remains fresh and engaging for both casual and competitive players."
      }
    ],
    "price": 0,
    "discount": 0,
